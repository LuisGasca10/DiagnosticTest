...
"@
    ...
    Write-Host " SOPTEC TECNICO   -   Manuel Rodriguez " -BackgroundColor Cyan -ForegroundColor Black
    Write-Host ""
...
while ($appCorriendo) {
    ...
    switch ($seleccion) {
        ...
        { $_ -in 'S', [char]27 } { 
            Write-Host "Saliendo del sistema Soptec..." -ForegroundColor Red
            $appCorriendo = $false 
        }
    }
}
